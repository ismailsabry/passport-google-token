...
var accessToken = req.body.access_token || req.query.access_token || req.headers.access_token || self._Bearer(req.headers);
...
* @api private
*/
GoogleTokenStrategy.prototype._Bearer = function(headers) {
var header = headers && headers['Authorization'.toLowerCase()];
